...
def _parse_response(*, client: Union[AuthenticatedClient, Client], response: httpx.Response) -> Optional[Union[Error, PutAccountMfaPreferenceResponse200]]:
...
def _build_response(*, client: Union[AuthenticatedClient, Client], response: httpx.Response) -> Response[Union[Error, PutAccountMfaPreferenceResponse200]]:
    return Response(
...
) -> Optional[Union[Error, PutAccountMfaPreferenceResponse200]]:
    """ Set the preferred 2FA method
