...
def _parse_response(*, client: Union[AuthenticatedClient, Client], response: httpx.Response) -> Optional[Union[Error, PatchOauthProvidersSlugResponse200]]:
...
def _build_response(*, client: Union[AuthenticatedClient, Client], response: httpx.Response) -> Response[Union[Error, PatchOauthProvidersSlugResponse200]]:
    return Response(
...
) -> Optional[Union[Error, PatchOauthProvidersSlugResponse200]]:
    """ Update a provider (admin)
