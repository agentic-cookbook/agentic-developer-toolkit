...
def _get_kwargs(
    slug: str,
    *,
    body: PatchOauthProvidersSlugBody | Unset = UNSET,
...
def _parse_response(*, client: AuthenticatedClient | Client, response: httpx.Response) -> Error | PatchOauthProvidersSlugResponse200 | None:
...
def _build_response(*, client: AuthenticatedClient | Client, response: httpx.Response) -> Response[Error | PatchOauthProvidersSlugResponse200]:
    return Response(
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        slug (str):
        body (PatchOauthProvidersSlugBody | Unset):
...
def sync(
    ...
    *,
    ...
    Returns:
        Error | PatchOauthProvidersSlugResponse200
     """
