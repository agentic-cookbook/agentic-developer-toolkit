...
def _parse_response(*, client: Union[AuthenticatedClient, Client], response: httpx.Response) -> Optional[Union[Error, PostOauthClientsResponse201]]:
...
def _build_response(*, client: Union[AuthenticatedClient, Client], response: httpx.Response) -> Response[Union[Error, PostOauthClientsResponse201]]:
    return Response(
...
) -> Optional[Union[Error, PostOauthClientsResponse201]]:
    """ Create an OAuth client + issue its app token (admin)
