...
def _parse_response(*, client: Union[AuthenticatedClient, Client], response: httpx.Response) -> Optional[Union[Error, PostBillingSubscriptionsResponse201]]:
...
def _build_response(*, client: Union[AuthenticatedClient, Client], response: httpx.Response) -> Response[Union[Error, PostBillingSubscriptionsResponse201]]:
    return Response(
...
) -> Optional[Union[Error, PostBillingSubscriptionsResponse201]]:
    """ Create subscriptions
