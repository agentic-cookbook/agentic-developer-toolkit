...
def _parse_response(*, client: Union[AuthenticatedClient, Client], response: httpx.Response) -> Optional[Union[Error, PostPersonaPersonasResponse201]]:
...
def _build_response(*, client: Union[AuthenticatedClient, Client], response: httpx.Response) -> Response[Union[Error, PostPersonaPersonasResponse201]]:
    return Response(
...
) -> Optional[Union[Error, PostPersonaPersonasResponse201]]:
    """ Create personas
