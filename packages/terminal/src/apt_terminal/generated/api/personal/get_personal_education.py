...
def _parse_response(*, client: AuthenticatedClient | Client, response: httpx.Response) -> Error | list[GetPersonalEducationResponse200Item] | None:
...
def _build_response(*, client: AuthenticatedClient | Client, response: httpx.Response) -> Response[Error | list[GetPersonalEducationResponse200Item]]:
    return Response(
...
def sync(
    *,
    ...
    Returns:
        Error | list[GetPersonalEducationResponse200Item]
     """
