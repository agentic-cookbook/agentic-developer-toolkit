...
def _parse_response(*, client: Union[AuthenticatedClient, Client], response: httpx.Response) -> Optional[Union[DeleteSystemServerBagKeyResponse200, Error]]:
...
def _build_response(*, client: Union[AuthenticatedClient, Client], response: httpx.Response) -> Response[Union[DeleteSystemServerBagKeyResponse200, Error]]:
    return Response(
...
) -> Optional[Union[DeleteSystemServerBagKeyResponse200, Error]]:
    """ Delete a server-bag entry (admin)
