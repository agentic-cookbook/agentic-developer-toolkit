...
def _parse_response(*, client: Union[AuthenticatedClient, Client], response: httpx.Response) -> Optional[Union[Error, PostPersonaMemoryMemoriesResponse201]]:
...
def _build_response(*, client: Union[AuthenticatedClient, Client], response: httpx.Response) -> Response[Union[Error, PostPersonaMemoryMemoriesResponse201]]:
    return Response(
...
) -> Optional[Union[Error, PostPersonaMemoryMemoriesResponse201]]:
    """ Create memories
