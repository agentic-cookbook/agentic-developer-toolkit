...
def _parse_response(*, client: AuthenticatedClient | Client, response: httpx.Response) -> Error | GetContentMarkdownExportResponse200 | None:
...
def _build_response(*, client: AuthenticatedClient | Client, response: httpx.Response) -> Response[Error | GetContentMarkdownExportResponse200]:
    return Response(
...
def sync(
    *,
    ...
    Returns:
        Error | GetContentMarkdownExportResponse200
     """
