...
def _get_kwargs(
    *,
    body: PostContentCategoryItemsBody | Unset = UNSET,
...
def _parse_response(*, client: AuthenticatedClient | Client, response: httpx.Response) -> Error | PostContentCategoryItemsResponse201 | None:
...
def _build_response(*, client: AuthenticatedClient | Client, response: httpx.Response) -> Response[Error | PostContentCategoryItemsResponse201]:
    return Response(
...
def sync_detailed(
    *,
    ...
    Args:
        body (PostContentCategoryItemsBody | Unset):
...
def sync(
    *,
    ...
    Returns:
        Error | PostContentCategoryItemsResponse201
     """
