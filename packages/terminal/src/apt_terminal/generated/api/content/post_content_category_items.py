...
def _parse_response(*, client: Union[AuthenticatedClient, Client], response: httpx.Response) -> Optional[Union[Error, PostContentCategoryItemsResponse201]]:
...
def _build_response(*, client: Union[AuthenticatedClient, Client], response: httpx.Response) -> Response[Union[Error, PostContentCategoryItemsResponse201]]:
    return Response(
...
) -> Optional[Union[Error, PostContentCategoryItemsResponse201]]:
    """ Create category_items
