...
def _parse_response(*, client: Union[AuthenticatedClient, Client], response: httpx.Response) -> Optional[Union[Error, PutContentSocialLinksIdResponse200]]:
...
def _build_response(*, client: Union[AuthenticatedClient, Client], response: httpx.Response) -> Response[Union[Error, PutContentSocialLinksIdResponse200]]:
    return Response(
...
) -> Optional[Union[Error, PutContentSocialLinksIdResponse200]]:
    """ Update social_links
