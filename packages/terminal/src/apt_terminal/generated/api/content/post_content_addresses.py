...
def _parse_response(*, client: Union[AuthenticatedClient, Client], response: httpx.Response) -> Optional[Union[Error, PostContentAddressesResponse201]]:
...
def _build_response(*, client: Union[AuthenticatedClient, Client], response: httpx.Response) -> Response[Union[Error, PostContentAddressesResponse201]]:
    return Response(
...
) -> Optional[Union[Error, PostContentAddressesResponse201]]:
    """ Create addresses
