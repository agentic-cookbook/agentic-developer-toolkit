...
def _get_kwargs(
    *,
    body: PostContentKeyValuePairsBody | Unset = UNSET,
...
def _parse_response(*, client: AuthenticatedClient | Client, response: httpx.Response) -> Error | PostContentKeyValuePairsResponse201 | None:
...
def _build_response(*, client: AuthenticatedClient | Client, response: httpx.Response) -> Response[Error | PostContentKeyValuePairsResponse201]:
    return Response(
...
def sync_detailed(
    *,
    ...
    Args:
        body (PostContentKeyValuePairsBody | Unset):
...
def sync(
    *,
    ...
    Returns:
        Error | PostContentKeyValuePairsResponse201
     """
