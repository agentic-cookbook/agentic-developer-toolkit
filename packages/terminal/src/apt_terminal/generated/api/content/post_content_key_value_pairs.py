...
def _parse_response(*, client: Union[AuthenticatedClient, Client], response: httpx.Response) -> Optional[Union[Error, PostContentKeyValuePairsResponse201]]:
...
def _build_response(*, client: Union[AuthenticatedClient, Client], response: httpx.Response) -> Response[Union[Error, PostContentKeyValuePairsResponse201]]:
    return Response(
...
) -> Optional[Union[Error, PostContentKeyValuePairsResponse201]]:
    """ Create key_value_pairs
