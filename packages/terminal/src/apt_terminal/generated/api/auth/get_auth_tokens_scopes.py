...
def _parse_response(*, client: Union[AuthenticatedClient, Client], response: httpx.Response) -> Optional[Union[Error, GetAuthTokensScopesResponse200]]:
...
def _build_response(*, client: Union[AuthenticatedClient, Client], response: httpx.Response) -> Response[Union[Error, GetAuthTokensScopesResponse200]]:
    return Response(
...
) -> Optional[Union[Error, GetAuthTokensScopesResponse200]]:
    """ List available REST path-prefix scopes that may be assigned to an API token
