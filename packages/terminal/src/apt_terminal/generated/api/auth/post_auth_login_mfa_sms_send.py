...
def _parse_response(*, client: Union[AuthenticatedClient, Client], response: httpx.Response) -> Optional[Union[Error, PostAuthLoginMfaSmsSendResponse202]]:
...
def _build_response(*, client: Union[AuthenticatedClient, Client], response: httpx.Response) -> Response[Union[Error, PostAuthLoginMfaSmsSendResponse202]]:
    return Response(
...
) -> Optional[Union[Error, PostAuthLoginMfaSmsSendResponse202]]:
    """ Send the SMS login code to the verified primary phone
