...
def _get_kwargs(
    *,
    body: PostAuthLinkProviderBody | Unset = UNSET,
...
def _parse_response(*, client: AuthenticatedClient | Client, response: httpx.Response) -> Error | PostAuthLinkProviderResponse200 | None:
...
def _build_response(*, client: AuthenticatedClient | Client, response: httpx.Response) -> Response[Error | PostAuthLinkProviderResponse200]:
    return Response(
...
def sync_detailed(
    *,
    ...
    Args:
        body (PostAuthLinkProviderBody | Unset):
...
def sync(
    *,
    ...
    Returns:
        Error | PostAuthLinkProviderResponse200
     """
