...
T = TypeVar("T", bound="GetCommunityDiscussionRepliesIdResponse200")



@_attrs_define
class GetCommunityDiscussionRepliesIdResponse200:
    """ 
        Attributes:
            id (str):
            ecosystem_id (str):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_community_discussion_replies_id_response_200 = cls(
            id=id,
        ...
        return get_community_discussion_replies_id_response_200
