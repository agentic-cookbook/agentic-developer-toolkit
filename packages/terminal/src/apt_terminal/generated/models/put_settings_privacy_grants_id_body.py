...
T = TypeVar("T", bound="PutSettingsPrivacyGrantsIdBody")



@_attrs_define
class PutSettingsPrivacyGrantsIdBody:
    """ 
        Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        put_settings_privacy_grants_id_body = cls(
        ...
        return put_settings_privacy_grants_id_body
