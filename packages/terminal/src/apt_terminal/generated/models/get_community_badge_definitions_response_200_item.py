...
T = TypeVar("T", bound="GetCommunityBadgeDefinitionsResponse200Item")



@_attrs_define
class GetCommunityBadgeDefinitionsResponse200Item:
    """ 
        Attributes:
            id (str):
            name (str):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_community_badge_definitions_response_200_item = cls(
            id=id,
            name=name,
            description=description,
            icon=icon,
        ...
        return get_community_badge_definitions_response_200_item
