...
class PutEcosystemEcosystemCapabilitiesEcosystemIdCapabilityResponse200:
    """ 
        Attributes:
            ecosystem_id (str):
            capability (str):
            config (Union['PutEcosystemEcosystemCapabilitiesEcosystemIdCapabilityResponse200ConfigType0Type1', None, bool,
                float, list[Any], str]):
            created_at (str):
            updated_at (str):
     """
    ...
    ecosystem_id: str
    capability: str
    config: Union['PutEcosystemEcosystemCapabilitiesEcosystemIdCapabilityResponse200ConfigType0Type1', None, bool, float, list[Any], str]
    created_at: str
    updated_at: str
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_config(data: object) -> Union['PutEcosystemEcosystemCapabilitiesEcosystemIdCapabilityResponse200ConfigType0Type1', None, bool, float, list[Any], str]:
            if data is None:
                return data
            try:
            ...
            try:
                ...
                pass
            return cast(Union['PutEcosystemEcosystemCapabilitiesEcosystemIdCapabilityResponse200ConfigType0Type1', None, bool, float, list[Any], str], data)
