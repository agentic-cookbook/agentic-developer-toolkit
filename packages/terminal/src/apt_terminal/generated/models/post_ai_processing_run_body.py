...
T = TypeVar("T", bound="PostAiProcessingRunBody")



@_attrs_define
class PostAiProcessingRunBody:
    """ 
        Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        post_ai_processing_run_body = cls(
        ...
        post_ai_processing_run_body.additional_properties = d
        return post_ai_processing_run_body
