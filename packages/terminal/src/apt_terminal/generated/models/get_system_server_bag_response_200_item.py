...
class GetSystemServerBagResponse200Item:
    """ 
        Attributes:
            key (str):
            value (Union['GetSystemServerBagResponse200ItemValueType1', None, bool, float, list[Any], str]):
            description (str):
            created_at (str):
            updated_at (str):
     """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_value(data: object) -> Union['GetSystemServerBagResponse200ItemValueType1', None, bool, float, list[Any], str]:
            if data is None:
                return data
            try:
            ...
            try:
                ...
                pass
            return cast(Union['GetSystemServerBagResponse200ItemValueType1', None, bool, float, list[Any], str], data)
