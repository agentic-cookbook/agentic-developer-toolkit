...
T = TypeVar("T", bound="GetEcosystemEcosystemCapabilitiesResponse200Item")



@_attrs_define
class GetEcosystemEcosystemCapabilitiesResponse200Item:
    """ 
        Attributes:
            ecosystem_id (str):
            capability (str):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_config(data: object) -> Union['GetEcosystemEcosystemCapabilitiesResponse200ItemConfigType0Type1', None, bool, float, list[Any], str]:
            ...
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                config_type_0_type_1 = GetEcosystemEcosystemCapabilitiesResponse200ItemConfigType0Type1.from_dict(data)
        ...
        get_ecosystem_ecosystem_capabilities_response_200_item = cls(
        ...
        return get_ecosystem_ecosystem_capabilities_response_200_item
