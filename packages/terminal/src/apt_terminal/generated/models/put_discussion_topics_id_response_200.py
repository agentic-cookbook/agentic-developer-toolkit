...
T = TypeVar("T", bound="PutDiscussionTopicsIdResponse200")



@_attrs_define
class PutDiscussionTopicsIdResponse200:
    """ 
        Attributes:
            id (str):
            customer_id (str):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        put_discussion_topics_id_response_200 = cls(
            id=id,
        ...
        return put_discussion_topics_id_response_200
