...
T = TypeVar("T", bound="GetPersonalContactsIdResponse200")



@_attrs_define
class GetPersonalContactsIdResponse200:
    """ 
        Attributes:
            id (str):
            customer_id (str):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_personal_contacts_id_response_200 = cls(
            id=id,
        ...
        return get_personal_contacts_id_response_200
