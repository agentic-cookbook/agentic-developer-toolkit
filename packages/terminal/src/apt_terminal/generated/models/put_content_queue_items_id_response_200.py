...
class PutContentQueueItemsIdResponse200:
    """ 
        Attributes:
            ...
            deleted_at (None | str):
            queue_id (str):
            payload (bool | float | list[Any] | None | PutContentQueueItemsIdResponse200PayloadType1 | str):
            status (str):
            enqueued_at (str):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_payload(data: object) -> bool | float | list[Any] | None | PutContentQueueItemsIdResponse200PayloadType1 | str:
            if data is None:
                return data
            try:
            ...
            try:
                ...
                pass
            return cast(bool | float | list[Any] | None | PutContentQueueItemsIdResponse200PayloadType1 | str, data)
