...
T = TypeVar("T", bound="GetPersonalContactsResponse200Item")



@_attrs_define
class GetPersonalContactsResponse200Item:
    """ 
        Attributes:
            id (str):
            customer_id (str):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_personal_contacts_response_200_item = cls(
            id=id,
        ...
        return get_personal_contacts_response_200_item
