...
T = TypeVar("T", bound="PutPersonalSocialLinksIdBody")



@_attrs_define
class PutPersonalSocialLinksIdBody:
    """ 
        Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        put_personal_social_links_id_body = cls(
        ...
        return put_personal_social_links_id_body
