...
T = TypeVar("T", bound="PostChatChatParticipantsResponse201")



@_attrs_define
class PostChatChatParticipantsResponse201:
    """ 
        Attributes:
            id (str):
            ecosystem_id (str):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        post_chat_chat_participants_response_201 = cls(
            id=id,
        ...
        return post_chat_chat_participants_response_201
