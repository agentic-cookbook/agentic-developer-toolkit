...
T = TypeVar("T", bound="PutChatChatMessagesIdResponse200")



@_attrs_define
class PutChatChatMessagesIdResponse200:
    """ 
        Attributes:
            id (str):
            owner_id (str):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        put_chat_chat_messages_id_response_200 = cls(
            id=id,
            owner_id=owner_id,
            chat_id=chat_id,
        ...
        return put_chat_chat_messages_id_response_200
