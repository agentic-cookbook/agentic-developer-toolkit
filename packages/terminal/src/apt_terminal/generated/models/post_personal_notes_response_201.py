...
T = TypeVar("T", bound="PostPersonalNotesResponse201")



@_attrs_define
class PostPersonalNotesResponse201:
    """ 
        Attributes:
            id (str):
            customer_id (str):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        post_personal_notes_response_201 = cls(
            id=id,
        ...
        return post_personal_notes_response_201
