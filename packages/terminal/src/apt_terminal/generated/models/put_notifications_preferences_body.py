...
if TYPE_CHECKING:
  from ..models.put_notifications_preferences_body_preferences_item import PutNotificationsPreferencesBodyPreferencesItem
...
class PutNotificationsPreferencesBody:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for preferences_item_data in (_preferences):
            preferences_item = PutNotificationsPreferencesBodyPreferencesItem.from_dict(preferences_item_data)
