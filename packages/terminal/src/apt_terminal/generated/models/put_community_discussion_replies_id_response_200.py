...
T = TypeVar("T", bound="PutCommunityDiscussionRepliesIdResponse200")



@_attrs_define
class PutCommunityDiscussionRepliesIdResponse200:
    """ 
        Attributes:
            id (str):
            ecosystem_id (str):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        put_community_discussion_replies_id_response_200 = cls(
            id=id,
        ...
        return put_community_discussion_replies_id_response_200
