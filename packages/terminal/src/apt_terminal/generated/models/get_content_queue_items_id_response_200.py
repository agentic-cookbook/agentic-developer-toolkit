...
if TYPE_CHECKING:
  from ..models.get_content_queue_items_id_response_200_payload_type_1 import GetContentQueueItemsIdResponse200PayloadType1
...
class GetContentQueueItemsIdResponse200:
    """ 
        Attributes:
            ...
            deleted_at (None | str):
            queue_id (str):
            payload (bool | float | GetContentQueueItemsIdResponse200PayloadType1 | list[Any] | None | str):
            status (str):
            enqueued_at (str):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_payload(data: object) -> bool | float | GetContentQueueItemsIdResponse200PayloadType1 | list[Any] | None | str:
            if data is None:
                return data
            try:
            ...
            try:
                ...
                pass
            return cast(bool | float | GetContentQueueItemsIdResponse200PayloadType1 | list[Any] | None | str, data)
