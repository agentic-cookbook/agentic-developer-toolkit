...
T = TypeVar("T", bound="PostCommunityDiscussionThreadsResponse201")



@_attrs_define
class PostCommunityDiscussionThreadsResponse201:
    """ 
        Attributes:
            id (str):
            ecosystem_id (str):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        post_community_discussion_threads_response_201 = cls(
            id=id,
        ...
        return post_community_discussion_threads_response_201
