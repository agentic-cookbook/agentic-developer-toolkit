...
T = TypeVar("T", bound="PostChatChatMessagesResponse201")



@_attrs_define
class PostChatChatMessagesResponse201:
    """ 
        Attributes:
            id (str):
            owner_id (str):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        post_chat_chat_messages_response_201 = cls(
            id=id,
            owner_id=owner_id,
            chat_id=chat_id,
        ...
        return post_chat_chat_messages_response_201
