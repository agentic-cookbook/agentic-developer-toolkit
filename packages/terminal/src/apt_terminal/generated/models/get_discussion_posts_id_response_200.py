...
T = TypeVar("T", bound="GetDiscussionPostsIdResponse200")



@_attrs_define
class GetDiscussionPostsIdResponse200:
    """ 
        Attributes:
            id (str):
            customer_id (str):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_discussion_posts_id_response_200 = cls(
            id=id,
        ...
        return get_discussion_posts_id_response_200
