...
T = TypeVar("T", bound="GetChatChatsResponse200Item")



@_attrs_define
class GetChatChatsResponse200Item:
    """ 
        Attributes:
            id (str):
            owner_user_id (str):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_chat_chats_response_200_item = cls(
            id=id,
        ...
        return get_chat_chats_response_200_item
