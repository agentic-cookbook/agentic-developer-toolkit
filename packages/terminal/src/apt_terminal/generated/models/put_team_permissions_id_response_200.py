...
T = TypeVar("T", bound="PutTeamPermissionsIdResponse200")



@_attrs_define
class PutTeamPermissionsIdResponse200:
    """ 
        Attributes:
            id (str):
            ecosystem_id (str):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        put_team_permissions_id_response_200 = cls(
            id=id,
        ...
        return put_team_permissions_id_response_200
