...
T = TypeVar("T", bound="PostGamificationBadgeDefinitionsResponse201")



@_attrs_define
class PostGamificationBadgeDefinitionsResponse201:
    """ 
        Attributes:
            id (str):
            name (str):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        post_gamification_badge_definitions_response_201 = cls(
            id=id,
            name=name,
            description=description,
            icon=icon,
        ...
        return post_gamification_badge_definitions_response_201
