...
class GetContentListItemsIdResponse200:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_value(data: object) -> Union['GetContentListItemsIdResponse200ValueType1', None, bool, float, list[Any], str]:
            if data is None:
                return data
            try:
            ...
            try:
                ...
                pass
            return cast(Union['GetContentListItemsIdResponse200ValueType1', None, bool, float, list[Any], str], data)
