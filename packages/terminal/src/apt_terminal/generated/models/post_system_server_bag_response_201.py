...
class PostSystemServerBagResponse201:
    """ 
        Attributes:
            key (str):
            value (bool | float | list[Any] | None | PostSystemServerBagResponse201ValueType1 | str):
            description (str):
            created_at (str):
            updated_at (str):
     """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_value(data: object) -> bool | float | list[Any] | None | PostSystemServerBagResponse201ValueType1 | str:
            if data is None:
                return data
            try:
            ...
            try:
                ...
                pass
            return cast(bool | float | list[Any] | None | PostSystemServerBagResponse201ValueType1 | str, data)
