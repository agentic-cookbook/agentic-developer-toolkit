...
T = TypeVar("T", bound="PutCommunityDiscussionConversationsIdResponse200")



@_attrs_define
class PutCommunityDiscussionConversationsIdResponse200:
    """ 
        Attributes:
            id (str):
            ecosystem_id (str):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        put_community_discussion_conversations_id_response_200 = cls(
            id=id,
        ...
        return put_community_discussion_conversations_id_response_200
