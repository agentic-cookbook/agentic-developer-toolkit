...
class PutCommunityDiscussionConversationsIdBody:
    """ 
        Attributes:
            ...
            participant_1_id (Union[Unset, str]):
            participant_2_id (Union[Unset, str]):
            last_message_at (Union[Unset, str]):
            participant_1_archived_at (Union[None, Unset, str]):
            participant_2_archived_at (Union[None, Unset, str]):
     """

    ecosystem_id: Union[Unset, str] = UNSET
    participant_1_id: Union[Unset, str] = UNSET
    participant_2_id: Union[Unset, str] = UNSET
