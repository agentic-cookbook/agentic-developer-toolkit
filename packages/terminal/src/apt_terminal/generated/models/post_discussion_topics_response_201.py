...
T = TypeVar("T", bound="PostDiscussionTopicsResponse201")



@_attrs_define
class PostDiscussionTopicsResponse201:
    """ 
        Attributes:
            id (str):
            customer_id (str):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        post_discussion_topics_response_201 = cls(
            id=id,
        ...
        return post_discussion_topics_response_201
