...
T = TypeVar("T", bound="GetChatChatMentionsResponse200Item")



@_attrs_define
class GetChatChatMentionsResponse200Item:
    """ 
        Attributes:
            id (str):
            ecosystem_id (str):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_chat_chat_mentions_response_200_item = cls(
            id=id,
        ...
        return get_chat_chat_mentions_response_200_item
