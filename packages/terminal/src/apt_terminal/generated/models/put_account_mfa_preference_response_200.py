...
from ..models.put_account_mfa_preference_response_200_preferred_method import PutAccountMfaPreferenceResponse200PreferredMethod
...
class PutAccountMfaPreferenceResponse200:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        d = dict(src_dict)
        preferred_method = PutAccountMfaPreferenceResponse200PreferredMethod(d.pop("preferredMethod"))
