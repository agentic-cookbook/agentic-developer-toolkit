...
T = TypeVar("T", bound="GetPersonaServiceTemplatesIdResponse200")



@_attrs_define
class GetPersonaServiceTemplatesIdResponse200:
    """ 
        Attributes:
            id (str):
            provider_kind (str):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_persona_service_templates_id_response_200 = cls(
            id=id,
        ...
        return get_persona_service_templates_id_response_200
