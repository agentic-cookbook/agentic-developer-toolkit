...
T = TypeVar("T", bound="GetDiscussionPostsResponse200Item")



@_attrs_define
class GetDiscussionPostsResponse200Item:
    """ 
        Attributes:
            id (str):
            customer_id (str):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_discussion_posts_response_200_item = cls(
            id=id,
        ...
        return get_discussion_posts_response_200_item
