...
T = TypeVar("T", bound="GetChatChatMessagesResponse200Item")



@_attrs_define
class GetChatChatMessagesResponse200Item:
    """ 
        Attributes:
            id (str):
            owner_id (str):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_client_message_id(data: object) -> None | str:
            if data is None:
                return data
            return cast(None | str, data)
        ...
        def _parse_tool_calls(data: object) -> None | str:
            if data is None:
                return data
            return cast(None | str, data)
        ...
        def _parse_reply_to_message_id(data: object) -> None | str:
            if data is None:
                return data
            return cast(None | str, data)
        ...
        def _parse_date_delivered(data: object) -> None | str:
            if data is None:
                return data
            return cast(None | str, data)
        ...
        get_chat_chat_messages_response_200_item = cls(
            id=id,
            owner_id=owner_id,
            chat_id=chat_id,
        ...
        return get_chat_chat_messages_response_200_item
