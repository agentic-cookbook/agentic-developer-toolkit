...
T = TypeVar("T", bound="GetPersonaServiceTemplatesResponse200Item")



@_attrs_define
class GetPersonaServiceTemplatesResponse200Item:
    """ 
        Attributes:
            id (str):
            provider_kind (str):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_persona_service_templates_response_200_item = cls(
            id=id,
        ...
        return get_persona_service_templates_response_200_item
