...
T = TypeVar("T", bound="PutCommunityBadgeDefinitionsIdResponse200")



@_attrs_define
class PutCommunityBadgeDefinitionsIdResponse200:
    """ 
        Attributes:
            id (str):
            name (str):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        put_community_badge_definitions_id_response_200 = cls(
            id=id,
            name=name,
            description=description,
            icon=icon,
        ...
        return put_community_badge_definitions_id_response_200
