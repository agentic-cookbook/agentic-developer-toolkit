...
T = TypeVar("T", bound="PutPersonaServiceTemplatesIdResponse200")



@_attrs_define
class PutPersonaServiceTemplatesIdResponse200:
    """ 
        Attributes:
            id (str):
            provider_kind (str):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        put_persona_service_templates_id_response_200 = cls(
            id=id,
        ...
        return put_persona_service_templates_id_response_200
