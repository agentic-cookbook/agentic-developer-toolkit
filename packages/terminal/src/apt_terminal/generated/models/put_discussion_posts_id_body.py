...
T = TypeVar("T", bound="PutDiscussionPostsIdBody")



@_attrs_define
class PutDiscussionPostsIdBody:
    """ 
        Attributes:
            owner_id (Union[Unset, str]):
            topic_id (Union[Unset, str]):
            parent_post_id (Union[None, Unset, str]):
            post_number (Union[Unset, int]):
    ...
    post_number: Union[Unset, int] = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if post_number is not UNSET:
            field_dict["postNumber"] = post_number
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        post_number = d.pop("postNumber", UNSET)
        ...
        put_discussion_posts_id_body = cls(
            owner_id=owner_id,
            topic_id=topic_id,
        ...
        return put_discussion_posts_id_body
