...
T = TypeVar("T", bound="PutChatChatParticipantsIdResponse200")



@_attrs_define
class PutChatChatParticipantsIdResponse200:
    """ 
        Attributes:
            id (str):
            ecosystem_id (str):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        put_chat_chat_participants_id_response_200 = cls(
            id=id,
        ...
        return put_chat_chat_participants_id_response_200
