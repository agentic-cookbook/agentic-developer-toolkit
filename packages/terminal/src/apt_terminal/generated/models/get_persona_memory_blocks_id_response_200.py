...
class GetPersonaMemoryBlocksIdResponse200:
    """ 
        Attributes:
            ...
            deleted_at (None | str):
            name (str):
            content (bool | float | GetPersonaMemoryBlocksIdResponse200ContentType1 | list[Any] | None | str):
            size_limit (int | None):
            created_at (str):
            updated_at (str):
     """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_content(data: object) -> bool | float | GetPersonaMemoryBlocksIdResponse200ContentType1 | list[Any] | None | str:
            if data is None:
                return data
            try:
            ...
            try:
                ...
                pass
            return cast(bool | float | GetPersonaMemoryBlocksIdResponse200ContentType1 | list[Any] | None | str, data)
