...
T = TypeVar("T", bound="GetCommunityDiscussionThreadsResponse200Item")



@_attrs_define
class GetCommunityDiscussionThreadsResponse200Item:
    """ 
        Attributes:
            id (str):
            ecosystem_id (str):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_community_discussion_threads_response_200_item = cls(
            id=id,
        ...
        return get_community_discussion_threads_response_200_item
