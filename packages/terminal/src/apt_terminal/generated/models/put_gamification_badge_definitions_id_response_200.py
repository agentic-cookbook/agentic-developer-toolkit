...
T = TypeVar("T", bound="PutGamificationBadgeDefinitionsIdResponse200")



@_attrs_define
class PutGamificationBadgeDefinitionsIdResponse200:
    """ 
        Attributes:
            id (str):
            name (str):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        put_gamification_badge_definitions_id_response_200 = cls(
            id=id,
            name=name,
            description=description,
            icon=icon,
        ...
        return put_gamification_badge_definitions_id_response_200
