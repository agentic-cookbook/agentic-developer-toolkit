...
T = TypeVar("T", bound="PutDiscussionPostsIdResponse200")



@_attrs_define
class PutDiscussionPostsIdResponse200:
    """ 
        Attributes:
            id (str):
            customer_id (str):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        put_discussion_posts_id_response_200 = cls(
            id=id,
        ...
        return put_discussion_posts_id_response_200
